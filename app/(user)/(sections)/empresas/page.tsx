...
export default function Empresa() {
    ...
    const fetchNews = debounce(async () => {
        ...
        const categoryString = "empresas = true";
    ...
    return (
        <>
            <Head>
                <link rel="preload" href="/empresaBg.jpg" as="image" />
            </Head>

            <div>
                <section className="bg-[url('/img/empresaBg.jpg')] bg-center bg-cover">
                    <div className="bg-gradient-to-t from-[#000000c8] to-[#00000032] flex flex-col justi pb-16 pt-32 px-12 md:px-10 lg:px-16 xl:px-24 2xl:px-28">
